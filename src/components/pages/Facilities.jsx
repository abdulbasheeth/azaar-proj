    ...
    return (
        <section id="Facilities" ref={sectionRef} className="mt-10 mb-10 lg:mt-2 lg:mb-10 bg-background pt-23">
            <div className="container mx-auto px-4">
                ...
                >
                    <span className="inline-block font-serif px-4 py-1.5 rounded-full bg-primary/20 text-2xl text-primary inline p-2 rounded-3xl text-[#1484F4] px-6 bg-[#D8E1EA] font-semibold mb-4">
                        In-House Facilities
                    </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6 auto-rows-[minmax(280px,auto)]">
                    {facilities.map((facility, index) => (
                        ...
                        >
                            ...
                            {/* Content */}
                            <div className="relative h-full p-6 lg:p-8 flex flex-col justify-end flex-grow">
